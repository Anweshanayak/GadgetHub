...
/*  CartCount Function gets  the size of User Orders*/
    ...
    //         	objectOutputStream.writeObject(orderPayments);
			...
			// 	if(session.getAttribute("usertype").equals("retailer"))
			// {
			// 	MySqlDataStoreUtilities.insertOrder(orderId,username(),orderName,orderPrice,userAddress,creditCardNo,street,city,state,zip);
			// }else
...
public String storeReview(String productname,String producttype,String productmaker,String reviewrating,String reviewdate,String  reviewtext,String reatilerpin,
	String storeid,String storestate,String productonsale,String manufacturerrebate,String usergender,String userid,String useroccupation,String price,String city,String userage){
	String message=MongoDBDataStoreUtilities.insertReview(productname,username(),producttype,productmaker,reviewrating,reviewdate,reviewtext,reatilerpin,storeid,storestate,productonsale,manufacturerrebate,usergender,userid,useroccupation,price,city,userage);
		...
		Review review = new Review(productname,username(),producttype,productmaker,reviewrating,reviewdate,reviewtext,reatilerpin,storeid,storestate,productonsale,manufacturerrebate,usergender,userid,useroccupation,price,city,userage);
