...
public class SubmitReview extends HttpServlet {
	...
	protected void storeReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String message=utility.storeReview(productname,producttype,productmaker,reviewrating,reviewdate,reviewtext,retailerpin,storeid,storestate,productonsale,manufacturerrebate,usergender,userid,useroccupation,productprice,retailercity,userage);				     
