...
public static String insertReview(String productname,String username,String producttype,String productmaker,String reviewrating,String reviewdate,String reviewtext,String retailerpin,String storeid,String storestate,String productonsale,String manufacturerrebate,String usergender,String userid,String useroccupation,String price,String retailercity,String userage)
{
	try
		{		
			getConnection();
			BasicDBObject doc = new BasicDBObject("title", "myReviews").
				...
				append("userocupation", useroccupation).
	...
	while (cursor.hasNext())
	{
		   ...
		   if(!reviews.containsKey(obj.getString("productName")))
			...
			Review review =new Review(obj.getString("productName"),obj.getString("userName"),obj.getString("productType"),obj.getString("productMaker"),
				obj.getString("reviewRating"),obj.getString("reviewDate"),obj.getString("reviewText"),obj.getString("retailerpin"),obj.getString("storeid"),obj.getString("storestate"),obj.getString("productonsale"),obj.getString("manufacturerrebate"),obj.getString("usergender"),obj.getString("userid"),obj.getString("useroccupation"),obj.getString("price"),obj.getString("retailercity"),obj.getString("userage"));
