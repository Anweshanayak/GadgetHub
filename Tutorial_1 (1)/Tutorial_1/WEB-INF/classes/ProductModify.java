...
public class ProductModify extends HttpServlet {
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<div id='container'><div class='post'>");
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='phones' selected>Phones</option><option value='laptops'>Laptops</option><option value='wts'>Wearable Tech</option><option value='vas'>Voice Assistants</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
		...
		}else if (action.equals("Updateproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					+ "<table id='bestseller'><tr><td>"
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='phones' selected>Phone</option><option value='laptops'>Laptop</option><option value='wts'>Wearable Tech</option>option value='vas'>Voice Assistants</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
					+ "<h3>Product Id</h3></td><td><input type='text' name='productId' value='' class='input' required></input>"
					+ "</td></tr><tr><td>"
					+ "<h3>Product Name</h3></td><td><input type='text' name='productName' value='' class='input' required></input>"
