...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("Order")!=null && request.getParameter("Order").equals("ViewOrder"))
		{
			...
			{	
				...
				{
					pw.print("<h4 style='color:red'>Invalid Order id.You have not placed any order with this order id.</h4>");
				}
			}else
				
			{
				pw.print("<h4 style='color:red'>Please enter valid order number.</h4>");	
			}
		}
				...
				for (OrderPayment oi : orderPayments.get(orderId)) 
					{
							if(oi.getOrderName().equals(orderName) && oi.getUserName().equals(username))
							{
								...
								pw.print("<h4 style='color:red'>Your order has been cancelled successfully.</h4>");								
							}
					}
